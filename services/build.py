...
HE_GUIDES = [
 {"slug":"fractional-cro-cost",
  "title":"כמה עולה CRO במיקור חוץ? | טל פאפרין",
  "desc":"תשובה ישירה על תמחור CRO במיקור חוץ: כמה זה עולה בחודש, איך זה משתווה ל-CRO במשרה מלאה של 250 אלף דולר, מה כלול, ומתי כל רמה שווה את זה.",
  "h1":"כמה באמת עולה CRO במיקור חוץ","eyebrow":"מדריך",
  "lead":"רוב היועצים מסתירים את המספר, מגישים לכם מצגת, ונעלמים. אני מפעיל שעדיין מוכר בעצמו, מחייב חודשית בלי חוזה, והנה בדיוק כמה עולה CRO במיקור חוץ, במספרים ברורים.",
  "sections":[
    {"h":"התשובה הקצרה","p":[
      "CRO במשרה מלאה עולה 250 אלף דולר ומעלה בסך הכל, אחרי שמוסיפים בסיס, אקוויטי, בונוס, סיכון פיצויי פיטורין ומחזור גיוס של חודשים. CRO במיקור חוץ נותן לכם את אותה בעלות בכירה בתשלום חודשי, ואתם משלמים רק על רמת המעורבות שהשלב שלכם באמת צריך."]},
    {"h":"שלוש הרמות","tiers":[
      ...
      "CRO Ownership, 22,000 דולר בחודש. בעלות מלאה ברמת CRO על ההכנסות, על פני מכירות, שיווק ו-Go-to-Market, כולל B2G, רשתות מפיצים ומשא ומתן חוזי מורכב, ואחריות מלאה על המספר."]},
    ...
    {"h":"אתם שוכרים מפעיל, לא יועץ","p":[
      "רוב היועצים מגישים לכם מצגת ונעלמים. הם מעולם לא נשאו אחריות על מספר. אני VP מכירות גלובלי ו-CRO לשעבר, ואני עדיין עושה את המכירה בעצמי, בפייפליין ובעסקאות. ואני מחייב חודשית בלי חוזה, אז אני שומר על העבודה בזכות זה שאני טוב בה, לא בזכות חוזה שכולא אתכם."]},
  ],
  "faqs":[
    {"q":"כמה עולה CRO במיקור חוץ?","a":"הפרויקטים שלי נעים בין 6,000 ל-22,000 דולר בחודש לפי רמת המעורבות, לעומת 250 אלף דולר ומעלה ל-CRO במשרה מלאה אחרי אקוויטי, בונוס ופיצויים."},
    {"q":"האם CRO במיקור חוץ זול יותר מ-CRO במשרה מלאה?","a":"כן. אתם מקבלים את אותה בעלות בכירה בלי המשכורת, האקוויטי, הבונוס, סיכון הפיצויים, מחזור הגיוס או ההתברגות הארוכה, ובלי נעילה לטווח ארוך."},
 ...
 {"slug":"fractional-cro-vs-outsourced-sales",
  ...
  "desc":"CRO במיקור חוץ, מכירות במיקור חוץ מלא, או מערכת שאתם מריצים לבד? פירוק ישיר של מה מתאים לשלב שלכם, ואיך לבחור.",
  "h1":"CRO במיקור חוץ מול מכירות במיקור חוץ","eyebrow":"מדריך",
  ...
  "sections":[
    {"h":"שלוש האפשרויות","tiers":[
      ...
      "CRO במיקור חוץ. אתם צריכים מנהיג בכיר שייקח בעלות על המספר וירוץ את התנועה איתכם, אבל העבודה עוד לא משרה מלאה. אני, בכיסא. הרמה האמצעית, ומה שרוב החברות בוחרות.",
    ...
    {"h":"איך לבחור","ul":[
      ...
      "אם הבעיה היא שאף אחד לא בעל המספר, קחו CRO במיקור חוץ",
      "אם הבעיה היא שאין לכם צוות ואין לכם זמן לבנות אחד, הוציאו את כל הפונקציה למיקור חוץ"]},
    {"h":"המבחן הכן","p":[
      "שאלו שאלה אחת: האם תנועת המכירות שלכם מוכחת? אם כן, אתם בעיקר צריכים ביצוע, אז מערכת או צוות במיקור חוץ יכולים להריץ אותה. אם לא, אתם צריכים בעלות בכירה כדי למצוא את התנועה קודם, וזה בדיוק מה ש-CRO במיקור חוץ עושה לפני שאתם מוציאים על צוות."]},
  ],
  "faqs":[
 ...
 {"slug":"fractional-cro-israel",
  ...
  "desc":"CRO במיקור חוץ לחברות B2B ישראליות שמוכרות בבית ובחו״ל. מנהיגות הכנסות בכירה, בעברית או באנגלית, בלי גיוס במשרה מלאה של 250 אלף דולר.",
  "h1":"CRO במיקור חוץ בישראל","eyebrow":"מדריך",
 ...
 {"slug":"fractional-cro-vs-vp-of-sales",
  ...
  "desc":"נמאס לכם מגיוסי VP מכירות של 30 אלף דולר בחודש שאתם מפטרים תוך 90 יום? CRO במיקור חוץ נותן מנהיגות הכנסות מוכחת בלי הימור גיוס, בלי פיצויים ובלי נעילה.",
  "h1":"CRO במיקור חוץ מול גיוס VP מכירות","eyebrow":"מדריך",
  ...
  "sections":[
    ...
    {"h":"CRO במיקור חוץ הוא לא הימור","ul":[
    ...
    {"h":"אני עדיין מוכר. בעצמי. ידיים בבוץ.","p":[
      "רוב היועצים מגישים לכם מצגת ונעלמים. הם מעולם לא נשאו אחריות על מספר. אני VP מכירות גלובלי ו-CRO לשעבר, ואני עדיין עושה את המכירה בעצמי, בטלפון, בחדר, בעסקה. אתם שוכרים מפעיל, לא יועץ."]},
  ...
  "faqs":[
    {"q":"האם CRO במיקור חוץ עדיף על גיוס VP מכירות?","a":"אם תנועת המכירות שלכם עוד לא מוכחת, כן. גיוס VP הוא הימור של שש ספרות עם חודשי חיפוש, רבעון התברגות וסיכון פיצויים אמיתי. CRO במיקור חוץ שעשה את זה 30 פעמים ומעלה מספק מהשבוע הראשון, בלי סיכון גיוס ובלי נעילה."},
