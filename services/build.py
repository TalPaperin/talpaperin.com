...
HE_SERVICES = [
 {"slug":"fractional-cro","nav":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ","h1":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ",
  ...
  "desc":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ שלוקח בעלות ואחריות על המספר. אסטרטגיה, צוות, פייפליין ותחזית, בלי גיוס יקר של משרה מלאה.",
  "eyebrow":"שירות",
 ...
 {"slug":"fractional-cro-vs-outsourced-sales",
  ...
  "sections":[
    {"h":"שלוש האפשרויות","tiers":[
      ...
      "סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ. אתם צריכים מנהיג בכיר שייקח בעלות על המספר וירוץ את התנועה איתכם, אבל העבודה עוד לא משרה מלאה. אני לוקח אחריות אישית. הרמה האמצעית, ומה שרוב החברות בוחרות.",
    ...
    {"h":"המבחן הכן","p":[
      "שאלו שאלה אחת: האם תנועת המכירות שלכם מוכחת? אם כן, אתם בעיקר צריכים ביצוע, אז מערכת או צוות במיקור חוץ יכולים להריץ אותה. אם לא, אתם צריכים בעלות בכירה כדי למצוא את התנועה קודם, וזה בדיוק מה ש-סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ עושה לפני שאתם מוציאים על צוות."]},
  ],
  "faqs":[
