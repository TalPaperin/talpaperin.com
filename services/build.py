...
HE_FOOTER = '''  <footer>
    <div class="wrap inner">
      ...
      <span>סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ &middot; התמחות בשוק האמריקאי &middot; עבודה בשעות פעילות ארה״ב</span>
    </div>
  </footer>
...
HE_SERVICES = [
 {"slug":"fractional-cro","nav":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ","h1":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ",
  ...
  "desc":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ שלוקח אחריות על המספר. אסטרטגיה, צוות, פייפליין ותחזית, בלי גיוס יקר של משרה מלאה.",
  "eyebrow":"שירות",
  "lead":"מנהיגות הכנסות בכירה שלוקחת אחריות על המספר. בלי משכורת של רבע מיליון דולר ובלי התחייבות ארוכת טווח.",
  "card":"אני לוקח אחריות על ההכנסות ועל המספר. שלב הביניים שרוב החברות בוחרות בו.",
  "sections":[
    {"h":"מתי צריך סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ?",
     ...
     "ul":["המכירות נתקעו ואף אחד לא באמת אחראי על המספר","אתם בצמיחה וצריכים מנהיג עוד לפני שאפשר להצדיק סמנכ״ל מכירות ופיתוח עסקי במשרה מלאה","סמנכ״ל מכירות ופיתוח עסקי שכיר עולה רבע מיליון דולר ומעלה בשנה, עם חודשים של גיוס וחימום וסיכוני פיצויים"]},
...
HE_FAQ = {
 ...
 "items": [
  ...
  ('כמה זמן לוקח לראות תוצאות?',
   ['אצלי, מהר. אבחון בשבוע הראשון, תוכנית בשבוע השני, ביצוע מהשבוע השלישי. אני לא מוכר מצגת, אני לוקח אחריות על המספר.']),
 ...
 {"slug":"fractional-cro-vs-outsourced-sales",
  ...
  "sections":[
    {"h":"שלוש האפשרויות","tiers":[
      ...
      "סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ. אתם צריכים מנהיג בכיר שייקח אחריות על המספר וירוץ את התנועה איתכם, אבל העבודה עוד לא משרה מלאה. אני לוקח אחריות אישית. הרמה האמצעית, ומה שרוב החברות בוחרות.",
    ...
    {"h":"איך לבחור","ul":[
      ...
      "אם הבעיה היא שאף אחד לא בעל המספר, קחו סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ",
  ...
  "faqs":[
    {"q":"כדאי לשכור סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ או להוציא את המכירות למיקור חוץ?","a":"שכרו סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ כשאף אחד לא בעל המספר והתנועה עוד לא מוכחת. הוציאו את כל הפונקציה למיקור חוץ כשאין לכם צוות ואין לכם זמן לבנות אחד ואתם רק רוצים שמכירות יקרו מחוץ למצבת כוח האדם."},
 ...
 {"slug":"fractional-cro-israel",
  ...
  "sections":[
    ...
    {"h":"על מה אני לוקח אחריות","ul":[
      "אסטרטגיית הכנסות, התחזית והאחריות על המספר",
...
# --- Country / market pages (one rich page per market) ---------------------

COUNTRIES = [
 {"slug":"united-states",
  "title":"Building a Sales Operation in the United States | Tal Paperin",
  "desc":"How to build and run B2B sales in the US market: the buyer culture, the pitfalls, and the sales team, subsidiary and support operation I build and run there.",
  "h1":"Building a Sales Operation in the United States","eyebrow":"Market",
  "lead":"The US is the biggest prize and the most expensive trap. I have built and run sales, teams, subsidiaries and support across the US, and here is how to win it without burning the bank.",
  "sections":[
    {"h":"Is the US actually your market?","p":[
    ...
    {"h":"How American buyers really buy","p":[
    ...
    {"h":"What I build and run in the US","ul":[
  ...
  "faqs":[
    {"q":"Do you actually sell in the US, or just advise?","a":"I sell. I have built and run sales operations in the US hands-on, and I still work in the pipeline and the deals, not just the strategy deck."},
    {"q":"Can you help open a US subsidiary?","a":"Yes, when it is the right time. I help you prove you can sell in the US first, then stand up the entity and the operation around a motion that already works, instead of bleeding costs on an entity with no revenue."},
    {"q":"How much does it cost?","a":"My engagements run $6,000 to $22,000 a month depending on how many hours a day you need me, billed monthly with no contract and no exit fines."}],
  "related":'See <a href="/services/market-entry">market entry</a>, <a href="/services/fractional-cro">the fractional CRO service</a>, or <a href="/contact">tell me where you want to expand</a>.'},

 {"slug":"germany",
  "title":"Building a Sales Operation in Germany | Tal Paperin",
  "desc":"Selling B2B in Germany: how German buyers actually buy, the Mittelstand, and the sales team, subsidiary and support operation I build and run there.",
  "h1":"Building a Sales Operation in Germany","eyebrow":"Market",
  "lead":"Germany is Europe's largest economy and one of its most rewarding markets, if you respect how it buys. I have built and managed sales teams in Germany, and here is what works and what fails.",
  "sections":[
    {"h":"Is Germany actually your market?","p":[
    ...
    {"h":"How German buyers really buy","p":[
    ...
    {"h":"What I build and run in Germany","ul":[
  ...
  "faqs":[
    {"q":"Do I need German-speaking salespeople?","a":"In most B2B segments, yes. Germans do business in German, and a native team signals you are serious about the market. I hire, train and manage that team for you."},
    {"q":"Do you actually operate in Germany, or just advise?","a":"I have built and managed sales teams in Germany hands-on. I do the work, not a deck."},
    {"q":"How much does it cost?","a":"Engagements run $6,000 to $22,000 a month depending on how many hours a day you need me, monthly with no contract."}],
  "related":'See <a href="/services/market-entry">market entry</a>, <a href="/services/sales-team-building">sales team building</a>, or <a href="/contact">tell me where you want to expand</a>.'},

 {"slug":"united-kingdom",
  "title":"Building a Sales Operation in the UK | Tal Paperin",
  "desc":"Selling B2B in the United Kingdom: how British buyers actually buy, and the sales team, subsidiary and support operation I build and run there.",
  "h1":"Building a Sales Operation in the United Kingdom","eyebrow":"Market",
  "lead":"The UK is often the smartest first English-speaking market into Europe. I have built and managed sales teams in England, and here is how to enter it without the false comfort of a shared language.",
  "sections":[
    {"h":"Is the UK actually your market?","p":[
      "A shared language makes the UK feel easy, which is exactly the trap. It is a sophisticated, competitive market with its own culture, and a gateway into Europe and beyond. I help you decide if it is the right entry point, then build it."]},
    {"h":"How British buyers really buy","p":[
      "British buyers are understated and polite, and their no is quiet. Enthusiasm stays muted even when interest is real, and a cheerful brilliant can mean almost anything. They value wit, competence and a low-pressure, consultative style, and they distrust hard selling. Read the understatement wrong and you misjudge every deal in the pipeline."]},
    {"h":"What I build and run in the UK","ul":[
      "A UK sales team, hired, trained and managed",
      "Positioning tuned to a consultative, low-pressure British style",
      "A UK entity when customers or hiring require it",
      "Tech support and customer service operations",
      "The CRM, pipeline, forecast and accountability"]},
    {"h":"How I would open the UK","p":[
      "Do not mistake the shared language for a shared culture. Sell consultatively, read the understatement, and use UK success as a springboard into the rest of Europe. I run it hands-on, in the seat."]},
  ],
  "faqs":[
    {"q":"Is the UK a good first market in Europe?","a":"Often yes, the shared language lowers friction, but the culture and buying style are their own. I help you decide and then build it."},
    {"q":"Do you actually operate in the UK?","a":"I have built and managed sales teams in England hands-on, not from a slide deck."},
    {"q":"How much does it cost?","a":"$6,000 to $22,000 a month depending on hours, monthly with no contract."}],
  "related":'See <a href="/services/market-entry">market entry</a>, <a href="/services/fractional-cro">the fractional CRO service</a>, or <a href="/contact">tell me where you want to expand</a>.'},

 {"slug":"japan",
  "title":"Building a Sales Operation in Japan | Tal Paperin",
  "desc":"Selling B2B in Japan: how Japanese buyers actually buy, consensus and trust, and the sales team, subsidiary and support operation I build and run there.",
  "h1":"Building a Sales Operation in Japan","eyebrow":"Market",
  "lead":"Japan is one of the hardest markets to crack and one of the most loyal once you do. I have built and managed sales teams in Japan, and here is how to earn your way in.",
  "sections":[
    {"h":"Is Japan actually your market?","p":[
      "Japan is large, wealthy and quality-obsessed, and it rewards patience like nowhere else. But it is slow, relationship-driven and intolerant of shortcuts. I help you judge whether you have the product and the patience for Japan, then build it properly."]},
    {"h":"How Japanese buyers really buy","p":[
      "Japanese buyers buy trust, quality and certainty, and they buy through consensus, not a single decision-maker. The decision moves through a group process, so the real work is building agreement across the organization, quietly, over time. Relationships and reliability matter more than a slick pitch, and a rushed, aggressive approach ends the conversation. Once you are trusted, you are a long-term partner."]},
    {"h":"What I build and run in Japan","ul":[
      "A Japanese sales team, hired, trained and managed",
      "Positioning and materials built for quality, trust and consensus buying",
      "A local entity and the right partners when the market requires it",
      "Tech support and customer service to Japanese reliability standards",
      "The CRM, pipeline, forecast and accountability"]},
    {"h":"How I would open Japan","p":[
      "Invest in relationships and local people, respect the consensus process, and never rush it. Quality and follow-through are everything. I do this hands-on, in the seat, with the patience the market demands."]},
  ],
  "faqs":[
    {"q":"Why is Japan so hard for foreign companies?","a":"It is relationship-driven, consensus-based and quality-obsessed, and it punishes shortcuts. With the right local people and patience it becomes one of your most loyal markets. I build that for you."},
    {"q":"Do you actually operate in Japan?","a":"I have built and managed sales teams in Japan hands-on."},
    {"q":"How much does it cost?","a":"$6,000 to $22,000 a month depending on hours, monthly with no contract."}],
  "related":'See <a href="/services/market-entry">market entry</a>, <a href="/services/fractional-cro">the fractional CRO service</a>, or <a href="/contact">tell me where you want to expand</a>.'},
]
...
HE_COUNTRIES = [
 {"slug":"united-states",
  "title":"בניית מערך מכירות בארצות הברית | טל פאפרין",
  "desc":"איך בונים ומריצים מכירות B2B בשוק האמריקאי: תרבות הקנייה, המלכודות, ומערך המכירות, החברה הבת והתמיכה שאני בונה ומנהל שם.",
  "h1":"בניית מערך מכירות בארצות הברית","eyebrow":"שוק",
  "lead":"ארה״ב היא הפרס הגדול ביותר והמלכודת היקרה ביותר. בניתי וניהלתי מכירות, צוותים, חברות בנות ותמיכה ברחבי ארה״ב, והנה איך לנצח שם בלי לשרוף את הקופה.",
  "sections":[
    {"h":"האם ארה״ב באמת השוק שלכם?","p":[
    ...
    {"h":"איך קונה אמריקאי באמת קונה","p":[
  ...
  "faqs":[
    {"q":"אתה באמת מוכר בארה״ב, או רק מייעץ?","a":"אני מוכר. בניתי וניהלתי מערכי מכירות בארה״ב בידיים, ואני עדיין עובד בפייפליין ובעסקאות, לא רק במצגת."},
    {"q":"אתה יכול לעזור לפתוח חברה בת בארה״ב?","a":"כן, בזמן הנכון. אני עוזר לכם קודם להוכיח שאתם יכולים למכור בארה״ב, ואז להקים את הישות והמערך סביב מנוע שכבר עובד, במקום לדמם עלויות על ישות בלי הכנסות."},
    {"q":"כמה זה עולה?","a":"הפרויקטים שלי נעים בין 6,000 ל-22,000 דולר בחודש לפי כמה שעות ביום אתם צריכים אותי, בחיוב חודשי בלי חוזה ובלי קנסות יציאה."}],
  "related":'ראו <a href="/he/services/market-entry">חדירה לשווקים</a>, <a href="/he/services/fractional-cro">שירות הסמנכ״ל מכירות ופיתוח עסקי במיקור חוץ</a>, או <a href="/he/contact">ספרו לי לאן אתם רוצים להתרחב</a>.'},

 {"slug":"germany",
  "title":"בניית מערך מכירות בגרמניה | טל פאפרין",
  "desc":"מכירות B2B בגרמניה: איך הקונה הגרמני באמת קונה, ה-Mittelstand, ומערך המכירות, החברה הבת והתמיכה שאני בונה ומנהל שם.",
  "h1":"בניית מערך מכירות בגרמניה","eyebrow":"שוק",
  "lead":"גרמניה היא הכלכלה הגדולה באירופה ואחד השווקים המתגמלים בה, אם מכבדים את האופן שבו היא קונה. בניתי וניהלתי צוותי מכירות בגרמניה, והנה מה עובד ומה נכשל.",
  "sections":[
    {"h":"האם גרמניה באמת השוק שלכם?","p":[
    ...
    {"h":"מה אני בונה ומנהל בגרמניה","ul":[
  ...
  "faqs":[
    {"q":"אני צריך אנשי מכירות דוברי גרמנית?","a":"ברוב פלחי ה-B2B, כן. גרמנים עושים עסקים בגרמנית, וצוות דובר שפת אם משדר שאתם רציניים לגבי השוק. אני מגייס, מכשיר ומנהל את הצוות הזה עבורכם."},
    {"q":"אתה באמת פועל בגרמניה, או רק מייעץ?","a":"בניתי וניהלתי צוותי מכירות בגרמניה בידיים. אני עושה את העבודה, לא מצגת."},
    {"q":"כמה זה עולה?","a":"הפרויקטים נעים בין 6,000 ל-22,000 דולר בחודש לפי כמה שעות ביום אתם צריכים אותי, חודשי בלי חוזה."}],
  "related":'ראו <a href="/he/services/market-entry">חדירה לשווקים</a>, <a href="/he/services/sales-team-building">בניית והכשרת צוות מכירות</a>, או <a href="/he/contact">ספרו לי לאן אתם רוצים להתרחב</a>.'},

 {"slug":"united-kingdom",
  "title":"בניית מערך מכירות בבריטניה | טל פאפרין",
  "desc":"מכירות B2B בבריטניה: איך הקונה הבריטי באמת קונה, ומערך המכירות, החברה הבת והתמיכה שאני בונה ומנהל שם.",
  "h1":"בניית מערך מכירות בבריטניה","eyebrow":"שוק",
  "lead":"בריטניה היא לעיתים קרובות שוק דובר האנגלית החכם ביותר לכניסה לאירופה. בניתי וניהלתי צוותי מכירות באנגליה, והנה איך להיכנס בלי הנוחות המדומה של שפה משותפת.",
  "sections":[
    {"h":"האם בריטניה באמת השוק שלכם?","p":[
    ...
    {"h":"מה אני בונה ומנהל בבריטניה","ul":[
  ...
  "faqs":[
    {"q":"בריטניה היא שוק כניסה טוב לאירופה?","a":"לעיתים קרובות כן, השפה המשותפת מורידה חיכוך, אבל התרבות וסגנון הקנייה הם משלהם. אני עוזר להחליט ואז בונה."},
    {"q":"אתה באמת פועל בבריטניה?","a":"בניתי וניהלתי צוותי מכירות באנגליה בידיים, לא ממצגת."},
    {"q":"כמה זה עולה?","a":"6,000 עד 22,000 דולר בחודש לפי שעות, חודשי בלי חוזה."}],
  "related":'ראו <a href="/he/services/market-entry">חדירה לשווקים</a>, <a href="/he/services/fractional-cro">שירות הסמנכ״ל מכירות ופיתוח עסקי במיקור חוץ</a>, או <a href="/he/contact">ספרו לי לאן אתם רוצים להתרחב</a>.'},

 {"slug":"japan",
  "title":"בניית מערך מכירות ביפן | טל פאפרין",
  "desc":"מכירות B2B ביפן: איך הקונה היפני באמת קונה, קונצנזוס ואמון, ומערך המכירות, החברה הבת והתמיכה שאני בונה ומנהל שם.",
  "h1":"בניית מערך מכירות ביפן","eyebrow":"שוק",
  "lead":"יפן היא אחד השווקים הקשים ביותר לפיצוח ואחד הנאמנים ביותר ברגע שמצליחים. בניתי וניהלתי צוותי מכירות ביפן, והנה איך מרוויחים את הכניסה.",
  "sections":[
    {"h":"האם יפן באמת השוק שלכם?","p":[
  ...
  "faqs":[
    {"q":"למה יפן כל כך קשה לחברות זרות?","a":"היא מבוססת יחסים, קונצנזוס ואובססיה לאיכות, והיא מענישה קיצורי דרך. עם האנשים המקומיים הנכונים וסבלנות היא הופכת לאחד השווקים הנאמנים שלכם. אני בונה את זה עבורכם."},
    {"q":"אתה באמת פועל ביפן?","a":"בניתי וניהלתי צוותי מכירות ביפן בידיים."},
    {"q":"כמה זה עולה?","a":"6,000 עד 22,000 דולר בחודש לפי שעות, חודשי בלי חוזה."}],
  "related":'ראו <a href="/he/services/market-entry">חדירה לשווקים</a>, <a href="/he/services/fractional-cro">שירות הסמנכ״ל מכירות ופיתוח עסקי במיקור חוץ</a>, או <a href="/he/contact">ספרו לי לאן אתם רוצים להתרחב</a>.'},
]
...
def build():
    ...
    # Country / market pages: /markets/<slug> (EN) and /he/markets/<slug> (HE)
    os.makedirs(os.path.join(ROOT, "markets"), exist_ok=True)
    os.makedirs(os.path.join(ROOT, "he", "markets"), exist_ok=True)
    for c in COUNTRIES:
        url = "%s/markets/%s" % (SITE, c["slug"])
        he_url = "%s/he/markets/%s" % (SITE, c["slug"])
        hreflang = ('  <link rel="alternate" hreflang="en" href="%s" />\n'
                    '  <link rel="alternate" hreflang="he" href="%s" />\n'
                    '  <link rel="alternate" hreflang="x-default" href="%s" />') % (url, he_url, url)
        ld = ('{"@context":"https://schema.org","@type":"Article",'
              ...
              '"author":{"@type":"Person","name":"Tal Paperin","url":"%s/"},'
              '"publisher":{"@type":"Organization","name":"Tal Paperin"},'
              '"mainEntityOfPage":"%s"}') % (esc(c["h1"]), esc(c["desc"]), SITE, url)
        crumb = ('{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":['
                 '{"@type":"ListItem","position":1,"name":"Home","item":"%s/"},'
                 '{"@type":"ListItem","position":2,"name":"%s","item":"%s"}]}'
                 ) % (SITE, esc(c["h1"]), url)
        faq_html, faq_ld = render_faq(c.get("faqs"))
        page = GUIDE_PAGE.format(
            title=esc(c["title"]), desc=esc(c["desc"]), url=url, site=SITE,
            h1=esc(c["h1"]), eyebrow=esc(c["eyebrow"]), lead=esc(c["lead"]),
            sections=render_guide_sections(c), faq=faq_html, faqld=faq_ld,
            related=c["related"], fonts=FONTS, analytics=ANALYTICS, nav=NAV,
            footer=FOOTER, cta=CTA_BOX, ld=ld, crumb=crumb, hreflang=hreflang)
        with open(os.path.join(ROOT, "markets", c["slug"] + ".html"), "w", encoding="utf-8") as f:
            f.write(page)
    for c in HE_COUNTRIES:
        url = "%s/he/markets/%s" % (SITE, c["slug"])
        en_url = "%s/markets/%s" % (SITE, c["slug"])
        hreflang = ('  <link rel="alternate" hreflang="he" href="%s" />\n'
                    '  <link rel="alternate" hreflang="en" href="%s" />\n'
                    '  <link rel="alternate" hreflang="x-default" href="%s" />') % (url, en_url, en_url)
        ld = ('{"@context":"https://schema.org","@type":"Article",'
        ...
        faq_html, faq_ld = render_faq(c.get("faqs"), "שאלות נפוצות")
        page = HE_GUIDE_PAGE.format(
            title=esc(c["title"]), desc=esc(c["desc"]), url=url, site=SITE,
            h1=esc(c["h1"]), eyebrow=esc(c["eyebrow"]), lead=esc(c["lead"]),
            sections=render_guide_sections(c), faq=faq_html, faqld=faq_ld,
            related=c["related"], fonts=HE_FONTS, analytics=ANALYTICS, nav=HE_NAV,
            footer=HE_FOOTER, cta=HE_CTA, ld=ld, crumb=crumb, hreflang=hreflang)
        with open(os.path.join(ROOT, "he", "markets", c["slug"] + ".html"), "w", encoding="utf-8") as f:
            f.write(page)

    print("Built %d EN + %d HE service pages, HE index, HE FAQ, %d guides + %d HE guides, %d markets"
          % (len(SERVICES), len(HE_SERVICES), len(GUIDES), len(HE_GUIDES), len(COUNTRIES)))
