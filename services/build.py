...
TESTIMONIALS_EN = [
 {"q": "We brought in Tal Paperin as our fractional VP of Sales from day one at KanduAi. He wasn't just a consultant, he acted as a true VP of Sales. He defined our Ideal Customer Profile, built our outbound playbook, hired and trained SDRs, and launched our outbound motion twice. If you're a founder trying to launch or relaunch sales from zero, Tal is who you want in your corner.", "name": "Ariel Shemesh", "role": "Co-Founder & CEO", "company": "KanduAI", "tag": "fractional-cro", "photo": ""},
 ...
 {"q": "Tal is a hard-working and trustworthy person. I have experience as a client, a partner and working for him directly. He is a man of his word, delivers on what he promises. A competent salesperson and strategist I would recommend him to any company wanting a fractional sales leader, channel manager or strategist.", "name": "Steve Burton", "role": "CRO", "company": "The Point Company", "tag": "fractional-cro", "photo": ""},
 {"q": "Working with Tal has been impactful. He helped us understand where the issues were in our sales process and provided us a roadmap to increase sales by creating custom SOPs and demonstrating every step very clearly. He is very responsive and communicates well. Highly recommended.", "name": "Amitay Stern", "role": "CEO", "company": "TypoDuctions & DRIFT", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "Tal is a sharp and smart marketer. In a short conversation, he was able to understand and analyze complex problems of understanding the market, customer analysis, and consumer mapping. He brought us quick and good solutions that do the job.", "name": "David Gallula, Ph.D.", "role": "Head of UED Research Institute, CEO of ProUX", "company": "", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "With just an initial 15 minute consulting call with Tal, I was able to identify new approaches that I am confident will lead to a significant increase in successful prospect meetings. Tal was friendly, gracious with his time, and a good listener. This session was one of the most helpful resources I have encountered.", "name": "Michael Teichberg", "role": "Founder", "company": "InventivHR", "tag": "sales-team-building", "photo": ""},
 {"q": "Tal provided me with wise advice. He listened to me and asked great questions that showed an advanced level of understanding and attention, and then gave very helpful advice and shared his ways of thinking on the matter. I was most impressed by his methodical way of thinking and experimenting in sales.", "name": "Neriya Rosner", "role": "Founder & CEO", "company": "SpecBite", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "Tal is a real professional! I've asked him to provide an opinion on commercialization of a medical device product. What I received is a deep dive into entire world of terms, key players and possibilities and, on the other hand, a clear recommendation and a guidance for proper planning of my next steps.", "name": "Yakov Nedlin", "role": "Founder", "company": "LIBACCORD", "tag": "market-entry", "photo": ""},
 {"q": "I had a great experience working with Tal Paperin. He gave me some great insight and ideas about how to take my business to the next dimension. He provides an array of services to help businesses make more money from domestic or international expansion. I would recommend using them for sure.", "name": "Sherman Barnes II", "role": "Head of Sales & Marketing", "company": "Trio Trucking", "tag": "market-entry", "photo": ""},
 {"q": "KSW is an incredible resource, but more importantly, there are very few people as talented as Tal when it comes to sales strategy. He helped close a publicly traded company for my startup.", "name": "Huw Nierenberg", "role": "Co-Founder", "company": "ePropertyCare", "tag": "fractional-cro", "photo": ""},
 {"q": "I had the pleasure to work with Tal. I can tell that Tal is a great team player, very energetic and enthusiastic to get things done. He was always willing to help and share his experience in international sales and project management. He is practical, analytic with solving skills and nice to have around!", "name": "Luisa Arroyave", "role": "Senior Manager", "company": "Walmart Global Sourcing", "tag": "market-entry", "photo": ""},
 {"q": "Tal Paperin has everything you want and need in a solutions consulting company: years of experience in both pre and post sales, connections in all the BRIC countries, knowledge in how to standout in many different types of markets, and more ways to increase your company's profitability.", "name": "Gabriel Heifets", "role": "HW Lead Engineer", "company": "Annapurna Labs (Amazon)", "tag": "market-entry", "photo": ""},
 {"q": "Tal has the knowledge and deep understanding to analyze and map the market competition in order to promote the comparative advantage for any category of products. Tal is the one you would like to have as your team leader.", "name": "Barak Kav", "role": "CEO", "company": "TAG Dental", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "Tal is extremely enthusiastic about his job, smart, professional and thorough, and was a pleasure to work with.", "name": "Daniel Weiser", "role": "Sr. Director BD & Sales, Americas", "company": "Silicom Ltd.", "tag": "fractional-cro", "photo": ""},
 ...
 {"q": "I had the pleasure of meeting Tal to discuss strategies and ideas for developing my business and improving sales. Tal had excellent ideas and opinions that I will be putting to use in the coming months. I highly recommend Tal for your business.", "name": "Daniel Tarlow", "role": "", "company": "GK8 by Galaxy", "tag": "go-to-market-strategy", "photo": ""},
...
TESTIMONIALS_HE = [
 ...
 {"q": "העבודה עם טל השפיעה עלינו בצורה מטורפת. הוא עזר לנו להבין בדיוק איפה היו הבעיות בתהליך המכירה שלנו, וסיפק לנו מפת דרכים ברורה להגדלת המכירות על ידי יצירת נהלי עבודה (SOPs) מותאמים אישית והדגמה חיונית של כל שלב ושלב. הוא זמין מאוד ותקשורתי ברמות הגבוהות ביותר. מומלץ בחום.", "name": "אמיתי שטרן", "role": "מנכ\"ל", "company": "TypoDuctions ו-DRIFT", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "טל הוא איש שיווק חד וחכם בצורה יוצאת דופן. בשיחה קצרה אחת, הוא הצליח להבין ולנתח בעיות מורכבות של הבנת שוק, ניתוח לקוחות ומיפוי צרכנים. הוא הביא לנו פתרונות מהירים ומעולים שעושים את העבודה בשטח.", "name": "ד\"ר דיוויד גלולה", "role": "מנהל מכון המחקר UED, מנכ\"ל ProUX", "company": "", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "כבר בשיחת ייעוץ ראשונית של 15 דקות בלבד עם טל, הצלחתי לזהות גישות חדשות שאני בטוח שיובילו לעלייה משמעותית בפגישות מוצלחות עם לקוחות פוטנציאליים. טל היה חברותי, נדיב בזמנו וקשוב מאוד. השיחה הזו הייתה אחד הכלים הכי יעילים ומועילים שנתקלתי בהם.", "name": "מייקל טייכברג", "role": "מייסד", "company": "InventivHR", "tag": "sales-team-building", "photo": ""},
 {"q": "טל נתן לי עצות חכמות ומדויקות. הוא הקשיב לי, שאל שאלות מצוינות שהראו רמת הבנה ותשומת לב גבוהה, ואז נתן עצות מועילות במיוחד ושיתף את דרכי החשיבה שלו בנושא. מה שהכי הרשים אותי זו הדרך המתודית שבה הוא חושב ומנווט בעולם המכירות.", "name": "נריה רוזנר", "role": "מייסדת ומנכ\"לית", "company": "SpecBite", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "טל הוא מקצוען אמיתי! ביקשתי ממנו חוות דעת על מסחור של מוצר בתחום המכשור הרפואי. מה שקיבלתי היה צלילת עומק מטורפת לכל עולם המושגים, שחקני המפתח והאפשרויות, ומצד שני, המלצה ברורה והכוונה מדויקת לתכנון השלבים הבאים שלי.", "name": "יעקב נדלין", "role": "מייסד", "company": "LIBACCORD", "tag": "market-entry", "photo": ""},
 {"q": "הייתה לי חוויה מדהימה בעבודה עם טל פאפרין. הוא נתן לי תובנות ורעיונות מעולים איך לקחת את העסק שלי לשלב הבא. הוא מציע מגוון רחב של שירותים שעוזרים לעסקים להרוויח יותר כסף מהתרחבות מקומית או בינלאומית. אני ממליץ לעבוד איתו ללא ספק.", "name": "שרמן בארנס השני", "role": "מנהל מכירות ושיווק", "company": "Trio Trucking", "tag": "market-entry", "photo": ""},
 {"q": "KSW היא משאב מדהים, אבל חשוב מכך, יש מעט מאוד אנשים מוכשרים כמו טל כשזה מגיע לאסטרטגיית מכירות. הוא עזר לסטארטאפ שלי לסגור עסקה עם חברה הנסחרת בבורסה.", "name": "היו ניירנברג", "role": "שותף מייסד", "company": "ePropertyCare", "tag": "fractional-cro", "photo": ""},
 {"q": "היה לי העונג לעבוד עם טל. אני יכולה להגיד שטל הוא שחקן צוות מדהים, מלא באנרגיה ורעב להשיג תוצאות. הוא תמיד שמח לעזור ולשתף מהניסיון שלו במכירות בינלאומיות ובניהול פרויקטים. הוא מעשי, אנליטי, בעל יכולת פתרון בעיות גבוהה, ופשוט אדם שכיף לעבוד לצידו!", "name": "לואיזה ארויאבה", "role": "מנהלת בכירה", "company": "Walmart Global Sourcing", "tag": "market-entry", "photo": ""},
 {"q": "לטל פאפרין יש כל מה שאתם רוצים וצריכים מחברת ייעוץ פתרונות: שנים של ניסיון ב-Pre-sales וב-Post-sales, קשרים ענפים בכל מדינות ה-BRIC, ידע מעשי איך להבליט את העסק שלכם בסוגים שונים של שווקים, והמון דרכים להגדיל את הרווחיות של החברה שלכם.", "name": "גבריאל הייפץ", "role": "מהנדס חומרה מוביל", "company": "Annapurna Labs (Amazon)", "tag": "market-entry", "photo": ""},
 {"q": "לטל יש את הידע וההבנה העמוקה הדרושים כדי לנתח ולמפות את תחרות השוק, במטרה לקדם את היתרון היחסי של כל קטגוריית מוצרים. טל הוא בדיוק האדם שאתם רוצים שיוביל את הצוות שלכם.", "name": "ברק קב", "role": "מנכ\"ל", "company": "TAG Dental", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "טל מלא בתשוקה ואנרגיה לעבודה שלו, הוא חכם, מקצועי ויסודי בצורה בלתי רגילה, והיה פשוט תענוג לעבוד איתו.", "name": "דניאל וייזר", "role": "מנהל בכיר BD ומכירות, אמריקה", "company": "Silicom Ltd.", "tag": "fractional-cro", "photo": ""},
 ...
 {"q": "היה לי העונג להיפגש עם טל ולדבר על אסטרטגיות ורעיונות לפיתוח העסק ולשיפור המכירות. לטל היו רעיונות ודעות מעולים שאני איישם בחודשים הקרובים. אני ממליץ בחום על טל לעסק שלכם.", "name": "דניאל תרלו", "role": "", "company": "GK8 by Galaxy", "tag": "go-to-market-strategy", "photo": ""},
 ...
 {"q": "טל כאיש קשר הוא נכס. טל לצידך לא יסולא בפז. הוא תמיד מגיע עם תובנות ומיקוד שוק, וכל דקה איתו מלאת אנרגיה ואפשרויות. הוא מזקק את המהות של כל רעיון עסקי והופך אותו לפעולה ולמפת דרכים ליעד שלך.", "name": "דניאל זטמן", "role": "שותף מייסד", "company": "Qii78", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "עבדתי לצד טל בצוות ה-BizDev והמכירות ב-TAG Dental. תמיד התרשמתי מהמקצועיות ומהתכונות האישיות שלו. טל מביא פתרון בעיות יצירתי, ידע רחב בין-תחומי ונכונות לעשות מה שצריך כדי להגיע לתוצאה.", "name": "בר ליבך", "role": "ראש מכירות ופיתוח עסקי גלובלי", "company": "MIS Implants", "tag": "sales-team-building", "photo": ""},
 {"q": "הייתי צריך עצה כנה ובלי בולשיט על מכירות ושיווק לעסק חדש. טל לא היסס לעזור, והעצה שלו באמת סידרה לי את הראש. התברר שטל הוא לא רק מומחה בתחומו אלא גם אדם נדיב שמוכן לעזור לאחרים.", "name": "הנס ברונקהורסט", "role": "מנהל IT", "company": "Bauwatch Group", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "היה לי הכבוד לעבוד עם טל במשך יותר משנה. הוא הוכיח את עצמו כמקצוען, מסור ונכס יקר. טל מתודי עם תשומת לב יוצאת דופן לפרטים, יחד עם יכולת לראות את התמונה הגדולה וכישורי אנשים מעולים, מה שהפך אותו לדמות מרכזית בכל פרויקט.", "name": "יאיר רוזנצוויג", "role": "סמנכ״ל מכירות ושירות", "company": "Galcon", "tag": "fractional-cro", "photo": ""},
 {"q": "טל העביר עבורנו סמינר בנושא גיוס כספים לרבני חב\"ד בקמפוסים בישראל. המשובים היו חיוביים בצורה גורפת. ההרצאה הייתה חלקה, מרתקת ומאוד פרקטית. טל הוא תענוג לעבוד איתו, וכישורי השיווק שלו הם מהטובים שיש.", "name": "הרב נתן רודין", "role": "מנהל", "company": "Chabad on Campus", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "התייעצתי עם טל על אסטרטגיות מכירה ו-LinkedIn, ואני לא יכולה להמליץ עליו מספיק. הוא אמר לי בצורה ברורה ותמציתית בדיוק מה הצעדים הבאים שלי כדי למנף את LinkedIn הלאה. יש לו ים של ידע, והוא מעביר אותו בצורה שקל להבין וליישם. ממליצה בחום!", "name": "אלישבע הדסון", "role": "יוצרת סרטים תיעודיים", "company": "Hudson Films", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "טל חכם ומלא ניסיון. הוא נתן לנו תובנות ורעיונות מעולים איך לוודא שכיסינו את כל זוויות המכירה, עם מחקר שוק מעמיק.", "name": "סם גינזברג", "role": "אדריכל הכנסות", "company": "SG Consulting", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "לפני שהכרתי את טל לא הכרתי את עולם המכירות הגלובליות. טל פתח לי עולם חדש שלא הכרתי והרשים אותי בידע העמוק שלו. אני בטוח שהוא אחד המומחים בתחומו, ואשמח להמליץ עליו כאחד מאנשי המכירות הטובים בעולם.", "name": "אריאל פרץ", "role": "בעלים ומנכ\"ל", "company": "AP Engineering", "tag": "market-entry", "photo": ""},
 ...
 {"q": "לטל פאפרין יש יכולת מדהימה למצוא לקחים, במיוחד לקחי מכירות, בכל דבר קטן בחיים, ואיכשהו ליישם אותם בהצלחה בעולם העסקי. אם אתם מחפשים איש מכירות שחי, אוכל ונושם מכירות, פתחו איתו שיחה.", "name": "פיל גימונד", "role": "מהנדס DevSecOps בכיר", "company": "Optro", "tag": "fractional-cro", "photo": ""},
 {"q": "התובנות של טל בעסקים, ובמיוחד במכירות, מדהימות. אני תמיד מצפה לקרוא את המחשבות שלו. לפעמים הן שנונות ומצחיקות, אבל תמיד מאוד מלמדות, ומשקפות את החוזק של שנות הניסיון שלו.", "name": "אודו קאלו", "role": "מהנדס ביו-רפואי", "company": "St George's University Hospitals NHS", "tag": "go-to-market-strategy", "photo": ""},
 {"q": "לטל יש סגנון ייחודי, ישיר ובלי שטויות, של לעזור ללקוחות למצוא את קהל היעד שלהם, להגיע אליו, ולמצב את עצמם כך שיבחינו בהם. הוא הולך את הקילומטר הנוסף ונותן ערך מתמשך, כי אכפת לו מההצלחה שלכם. תעשו לעצמכם טובה ופנו אליו.", "name": "דוד אורבך", "role": "עובד סוציאלי", "company": "Jerusalem Mental Health Center", "tag": "go-to-market-strategy", "photo": ""},
