...
HE_SERVICES = [
 {"slug":"fractional-cro","nav":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ","h1":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ",
  ...
  "desc":"סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ שיושב על הכיסא ולוקח בעלות על המספר. אסטרטגיה, צוות, פייפליין ותחזית, בלי גיוס יקר של משרה מלאה.",
  "eyebrow":"שירות",
 ...
 {"slug":"fractional-cro-vs-outsourced-sales",
  ...
  "sections":[
    {"h":"שלוש האפשרויות","tiers":[
      ...
      "סמנכ״ל מכירות ופיתוח עסקי במיקור חוץ. אתם צריכים מנהיג בכיר שייקח בעלות על המספר וירוץ את התנועה איתכם, אבל העבודה עוד לא משרה מלאה. אני, בכיסא. הרמה האמצעית, ומה שרוב החברות בוחרות.",
